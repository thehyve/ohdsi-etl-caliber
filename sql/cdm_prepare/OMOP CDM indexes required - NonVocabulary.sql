...
CREATE INDEX idx_cohort_subject_id ON cdm5.cohort (subject_id ASC);
CREATE INDEX idx_cohort_c_definition_id ON cdm5.cohort (cohort_definition_id ASC);

CREATE INDEX idx_ca_subject_id ON cdm5.cohort_attribute (subject_id ASC);
CREATE INDEX idx_ca_definition_id ON cdm5.cohort_attribute (cohort_definition_id ASC);
